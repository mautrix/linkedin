...
type Creator struct {
	...
	Type                  string                   `json:"_type,omitempty"`
	ParticipantType       typesold.ParticipantType `json:"participantType,omitempty"`
	RecipeType            string                   `json:"_recipeType,omitempty"`
...
type MessageElement struct {
	...
	Actor                     typesold.ConversationParticipant `json:"actor,omitempty"`
	RenderContentFallbackText any                              `json:"renderContentFallbackText,omitempty"`
	EntityUrn                 string                           `json:"entityUrn,omitempty"`
	Sender                    typesold.ConversationParticipant `json:"sender,omitempty"`
...
type ThreadElement struct {
	...
	ConversationParticipants            []typesold.ConversationParticipant `json:"conversationParticipants,omitempty"`
...
type MessageSeenReceipt struct {
	...
	SeenByParticipant typesold.ConversationParticipant `json:"seenByParticipant,omitempty"`
}
...
type MessengerMessagingParticipantsByMessageAndEmojiResponse struct {
	...
	Metadata     Metadata                           `json:"metadata,omitempty"`
	RecipeType   string                             `json:"_recipeType,omitempty"`
	Participants []typesold.ConversationParticipant `json:"elements,omitempty"`
}

type TypingIndicator struct {
	Type              string                           `json:"_type,omitempty"`
	TypingParticipant typesold.ConversationParticipant `json:"typingParticipant,omitempty"`
	RecipeType        string                           `json:"_recipeType,omitempty"`
	Conversation      Conversation                     `json:"conversation,omitempty"`
}
