...
func (c *Client) realtimeConnectLoop() {
	...
	for {
		...
		req.Header.Add("Accept", types2.ContentTypeTextEventStream)
		req.Header.Add("x-li-realtime-session", c.realtimeSessionID.String())
		req.Header.Add("x-li-recipe-accept", types2.ContentTypeJSONLinkedInNormalized)
		req.Header.Add("x-li-query-accept", types2.ContentTypeGraphQL)
		req.Header.Add("x-li-accept", types2.ContentTypeJSONLinkedInNormalized)
		...
		for {
			...
			var realtimeEvent types2.RealtimeEvent
